...
@section('hero')
        <!-- hero sec start -->
        <section class="hero-sec register"  style="background-image: url({{asset('public/assets/images/banner/group.png')}});">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="mb-3 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
